          ...
          TableCalendar(
            ...
            calendarStyle: const CalendarStyle(
              selectedTextStyle: TextStyle(
                color: Colors.blue, // Change this color to the desired color for the selected date
                fontWeight: FontWeight.bold,
              ),
                                ...
                                MaterialPageRoute(
                                  builder: (context) =>
                                      addNewVaccineAppointment(
                                          selectedDay: _selectedDay, time: _selectTime, healthId: widget.healthId),
                                ));
                            },
                          ),
                        ),
                            ...
                            child: IconButton(
                              ...
                              onPressed: () {
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder: (context) => editVaccineAppointment(
                                      selectedDay: _selectedDay,
                                      time: _selectTime,
                                      healthId: widget.healthId,
                                      vaccinationAppointmentId: vaccinationAppointmentData[i].vaccinationAppointmentId,
                                    ),
                                  ),
                                );
                              },
                            ...
                            child: IconButton(
                              ...
                              onPressed: () async {
                                DocumentReference documentReference =
                                      FirebaseFirestore.instance.collection("Vaccination Appointment").doc(vaccinationAppointmentData[i].vaccinationAppointmentId);
                            ...
                            child: IconButton(
                              ...
                              onPressed: () {
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder: (context) => addNewVaccineAppointment(
                                      selectedDay: _selectedDay,
                                      time: _selectTime,
                                      healthId: widget.healthId,
                                    ),
